...
var PACKAGES = [
  ...
  { id:'p10', name:'Classic Kenya Safari', dest:'Kenya', duration:'7 Days', emoji:'🐘',
    ...
    itinerary:[
      ...
      { day:'Day 3', title:'Amboseli → Masai Mara', desc:'A long transfer across the southern Rift Valley into the sweeping Mara ecosystem. Arrival brings wildebeest and zebra herds, resident elephants and dense predator populations. Evening orientation drive.' },
      { day:'Day 4', title:'Masai Mara Full Day', desc:'Open plains, riverine acacia corridors and rocky kopjes concentrate wildlife. Hunting cheetahs, territorial lion prides and leopards near outcrops.' },
      { day:'Day 5', title:'Masai Mara Full Day (Optional Balloon)', desc:'Dawn light over the plains and, in migration season, dramatic river crossings with dense wildebeest herds. Optional sunrise balloon safari.' },
      { day:'Day 6', title:'Masai Mara → Lake Naivasha → Lake Nakuru', desc:'Depart the Mara and pass by Lake Naivasha for a boat ride and views of fish eagles and hippos, then continue to Lake Nakuru for an evening game drive among flamingos, rhino and buffalo. Overnight at Nakuru.' },
      { day:'Day 7', title:'Lake Nakuru → Nairobi', desc:'Breakfast at camp, then checkout and drive back through highland farmland to Nairobi to conclude the safari.' },
    ],
